            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="tipe" header="Tipe" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="nama" header="Nama" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="izin" header="Izin" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="jumlah_pengguna" header="Jumlah Pengguna" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
